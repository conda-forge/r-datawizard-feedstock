...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-datawizard-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-datawizard-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-datawizard
# for installing globally
pixi global install r-datawizard
```
...
It is possible to list all of the versions of `r-datawizard` available on your platform:
...
```
pixi search r-datawizard --channel conda-forge
```
