...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-datawizard-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13356&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-datawizard-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-datawizard` can be installed with:

```
conda install r-datawizard
```

It is possible to list all of the versions of `r-datawizard` available on your platform with:
